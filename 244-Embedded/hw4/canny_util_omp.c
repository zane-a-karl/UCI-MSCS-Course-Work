        ...
        short int **smoothedim)
{
   ...
   ****************************************************************************/
	 omp_set_dynamic(0); // We do not want the sys to dynamically vary the number of threads from one parallel construct to another
	 omp_set_num_threads(n_thread); // n_thread should already be 4
